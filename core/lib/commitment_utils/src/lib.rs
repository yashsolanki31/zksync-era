...
pub fn events_queue_commitment(
    ...
    match VmVersion::from(protocol_version) {
        VmVersion::VmBoojumIntegration => Some(H256(
            zkevm_test_harness_1_4_0::events_queue_commitment_fixed(
                &events_queue
                    .iter()
        ...
        VmVersion::Vm1_4_1 | VmVersion::Vm1_4_2 => Some(H256(
            zkevm_test_harness_1_4_1::events_queue_commitment_fixed(
                &events_queue
                    .iter()
...
pub fn bootloader_initial_content_commitment(
    ...
    match VmVersion::from(protocol_version) {
        VmVersion::VmBoojumIntegration => Some(H256(
            zkevm_test_harness_1_4_0::initial_heap_content_commitment_fixed(
                &full_bootloader_memory,
            ),
        )),
        VmVersion::Vm1_4_1 | VmVersion::Vm1_4_2 => Some(H256(
            zkevm_test_harness_1_4_1::initial_heap_content_commitment_fixed(
                &full_bootloader_memory,
            ),
        )),
        _ => unreachable!(),
