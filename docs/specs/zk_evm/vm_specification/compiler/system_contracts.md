...
[System Contracts](https://docs.zksync.io/build/developer-reference/era-contracts/system-contracts). Among them are: `ORIGIN`,
...
Both [zksolc](https://docs.zksync.io/zk-stack/components/compiler/toolchain/solidity) and
[zkvyper](https://docs.zksync.io/zk-stack/components/compiler/toolchain/vyper) compilers for EraVM operate on
[the IR level](https://docs.zksync.io/zk-stack/components/compiler/toolchain#ir-compilers), so they cannot control
